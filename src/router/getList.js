    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                parentId = getQueryItem(request.query, 'parentId') || '0';
                sql = "SELECT * FROM \"filelist\" WHERE \"parent_id\" = ".concat(parentId);
                return [4 /*yield*/, new Promise(function (resolve) {
                        conn.all(sql, function (_error, rows) {
                            resolve(rows);
                        });
                    })];
            case 2:
...
function getQueryItem(query, name) {
    if (!query || !query[name])
        return '';
    return query[name];
}
